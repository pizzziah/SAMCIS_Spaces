...
public class UsersEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adminApply.setOnClickListener(v -> {
            startActivity(new Intent(UsersEditProfileActivity.this, AdminApplication.class));
            finish();
        });
    }
        ...
        if (user != null) {
            ...
            db.collection("Users").document(userId)
                    ...
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Intent intent = new Intent(UsersEditProfileActivity.this, UserProfileFragment.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(UsersEditProfileActivity.this, "Failed to update profile: " + e.getMessage(), Toast.LENGTH_LONG).show());
        }
    }
}
